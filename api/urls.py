...
urlpatterns = [
    ...
    path('<int:project_id>/<int:task_id>/',
         views.task_detail, name="project_all_task"),
    path('<int:project_id>/create_task/',
         views.task_create, name="project_all_task"),
    path('<int:project_id>/<int:task_id>/update',
         views.task_update, name="project_all_task"),
    path('<int:project_id>/<int:task_id>/delete/',
         views.task_delete, name="project_all_task"),
